...
public class MELoggerBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag flag) {
        if (MELoggerItems.hasHistoryId(stack)) {
            tooltipComponents.add(Component.translatable("tooltip.appliedhistory.me_logger.ready")
                    .withStyle(ChatFormatting.GREEN));
        } else {
            tooltipComponents.add(Component.translatable("tooltip.appliedhistory.me_logger.invalid")
                    .withStyle(ChatFormatting.RED));
        }
        tooltipComponents.add(Component.translatable("tooltip.appliedhistory.me_logger.obtain_dormant")
